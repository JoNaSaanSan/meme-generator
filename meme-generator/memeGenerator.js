...
window.addEventListener('DOMContentLoaded', function() {
  ...
  const preview4 = document.getElementById('4');
  const preview5 = document.getElementById('5');
  ...
  //load preview (next 5 images)
  function loadPreview(){
    document.getElementById("1").src = memes[currentImageID].url;
    document.getElementById("2").src = memes[currentImageID + 1].url;
    document.getElementById("3").src = memes[currentImageID + 2].url;
    document.getElementById("4").src = memes[currentImageID + 3].url;
    document.getElementById("5").src = memes[currentImageID + 4].url;
    console.log("loadPreview " + currentMeme)
  }
  

  // image is selected from preview
  function imageSelection(mycurrentimageID){
    showImage(mycurrentimageID);
    console.log("currentimageID" + mycurrentimageID);
  }
